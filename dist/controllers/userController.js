...
exports.suspendedAccountActivation = exports.verifyBankTransferPinController = exports.createTransferPinController = exports.getBankAccountDetailsController = exports.deleteController = exports.getSingleController = exports.verifyPhoneController = exports.registerPhoneController = exports.changePasswordController = exports.changePasswordOTPVerificationController = exports.forgotPasswordController = exports.logOutController = exports.verifyEmailController = exports.loginController = exports.registerController = void 0;
...
// register user phone
exports.registerPhoneController = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
// verify user phone
exports.verifyPhoneController = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const id = (_a = req.user) === null || _a === void 0 ? void 0 : _a._id;
    const { OTP } = req.body;
    if (!id || !OTP) {
