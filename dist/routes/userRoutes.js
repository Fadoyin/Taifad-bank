...
userRouter.get("/logout", checkUserAuth_1.checkUserAuthMiddelware, userController_1.logOutController);
...
userRouter.post("/registerPhone", checkUserAuth_1.checkUserAuthMiddelware, userController_1.registerPhoneController);
userRouter.post("/verifyPhone", checkUserAuth_1.checkUserAuthMiddelware, userController_1.verifyPhoneController);
/* User Routes */
userRouter.get("/:id", checkUserAuth_1.checkUserAuthMiddelware, userController_1.getSingleController);
userRouter.delete("/delete/:id", checkUserAuth_1.checkUserAuthMiddelware, userController_1.deleteController);
// create payment  pin
